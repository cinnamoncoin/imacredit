...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless imacredit

See readme-qt.rst for instructions on building IMAcredit-Qt, the graphical user interface.
...
To compile IMAcredit with GNU make:
...
Security
--------
To help make your imacredit installation more secure by making certain attacks impossible to
